...
<body>
	...
	<div class="super_container">
		...
		<div class="main_slider">
			<img class="img-banner" id="img-banner" src="./admin/imgs/banner.jpg" alt="" width="100%" height="600px">
		...
		<script>
            ...
            var i = 0;
            var imgs = ["./admin/imgs/banner2.jpg", "./admin/imgs/banne3.jpg", "./admin/imgs/banner.jpg", "./admin/imgs/banne4.jpg"];
								...
								<div class="product-item men">
									<div class="product discount product_filter">
										<div class="product_image">
											<img src="<?= $img ?>" alt="" style="height: 230px">
										</div>
